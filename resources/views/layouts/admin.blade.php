...
<head>
  ...
  <link rel="stylesheet" href="{{asset('asset/admin/bundles/pretty-checkbox/pretty-checkbox.min.css')}}">
  <!-- Custom style CSS -->
...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{ route('admin-dashboard') }}"> <img alt="image" src="{{asset('asset/upload/images/'.Helper::logo())}}" class="header-logo" width="100%" /><!--  <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">Front</li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="sliders"></i></i><span>General Settings</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('admin-header')}}">Header</a></li>
                <li><a class="nav-link" href="{{route('admin-logo')}}">Logo</a></li>
                <li><a class="nav-link" href="{{route('admin-banner')}}">Sliders</a></li>
                <li><a class="nav-link" href="{{route('admin-footer')}}">Footer</a></li>
                <li><a class="nav-link" href="{{route('admin-social')}}">Social</a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="{{route('admin-brand-list')}}"><i data-feather="feather"></i><span>Brand</span></a></li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="airplay"></i><span>Service</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('admin-service')}}">Service List</a></li>
                <li><a class="nav-link" href="{{route('admin-serviceitem')}}">Service Item</a></li>
                <li><a class="nav-link" href="{{route('admin-service-price')}}">Price</a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="{{route('admin-currency')}}"><i data-feather="dollar-sign"></i><span>Currency</span></a></li>
            <li><a class="nav-link" href="{{route('admin-contact')}}"><i data-feather="globe"></i><span>Contact</span></a></li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="crosshair"></i><span>Portfolio</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('admin-portfolios-list')}}">Portfolio</a></li>
                <li><a class="nav-link" href="{{route('admin-category')}}">Portfolio category</a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="{{route('admin-chooseus')}}"><i data-feather="flag"></i><span>Why Choose Us</span></a></li>

            <li><a class="nav-link" href="{{route('admin-ourgoal')}}"><i data-feather="globe"></i><span>Our Goals</span></a></li>
  ...
  <script src="{{asset('asset/admin/bundles/sweetalert/sweetalert.min.js')}}"></script>
  <!-- Page Specific JS File -->
  <script src="{{asset('asset/admin/js/page/sweetalert.js')}}"></script>
  <script type="text/javascript" src="{{asset('asset/admin/js/jquery.charactercounter.js')}}"></script>
  <!-- Template JS File -->
