			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				...
				<div class="post">
					...
					<div class="post-image-wrapper">
						<img src="{{asset('asset/front/images/blog/blog1.jpg')}}" class="img-fluid" alt="" />
				...
				<div class="post">
					...
					<div class="post-image-wrapper">
						<div class="video-embed">
							<!-- Change the url -->
							<iframe src="http://player.vimeo.com/video/72266001?title=0&amp;byline=0&amp;portrait=0&amp;color=8aba56"
				...
				<div class="post">
					<!-- post image start -->
					<div class="post-image-wrapper">
						<img src="{{asset('asset/front/images/blog/blog2.jpg')}}" class="img-fluid" alt="" />
								...
								<ul class="posts-list list-unstyled clearfix">
									<li>
										<div class="posts-thumb float-left">
											<a href="#">
												<img alt="img" src="{{asset('asset/front/images/blog/blog1.jpg')}}">
											</a>
										</div>
									...
									<li>
										<div class="posts-thumb float-left">
											<a href="#">
												<img alt="img" src="{{asset('asset/front/images/blog/blog2.jpg')}}">
											</a>
										</div>
										<div class="post-content">
									...
									<li>
										<div class="posts-thumb float-left">
											<a href="#">
												<img alt="img" src="{{asset('asset/front/images/blog/blog3.jpg')}}">
											</a>
										</div>
										<div class="post-content">
											<h4 class="entry-title">
								...
								<ul class="posts-list list-unstyled clearfix">
									<li>
										<div class="posts-avator float-left">
											<a href="#">
												<img alt="img" src="{{asset('asset/front/images/blog/avator1.png')}}">
											</a>
										</div>
										<div class="post-content">
									...
									<li>
										<div class="posts-avator float-left">
											<a href="#">
												<img alt="img" src="{{asset('asset/front/images/blog/avator2.jpg')}}">
											</a>
										</div>
										<div class="post-content">
